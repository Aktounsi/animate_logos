...
def coral_loss(logits, levels, importance_weights=None, reduction='mean'):
    ...
    *Rank Consistent Ordinal Regression for Neural Networks
    ...
    Args:
        ...
        reduction (str): If 'mean' or 'sum', returns the averaged or summed loss value across
        all data points (rows) in logits. If None, returns a vector of shape (num_examples,).
