...
def transform_animation_predictor_output(file, animation_id, output):
    ...
    Example: transform_animation_predictor_output("data/svgs/logo_1.svg", 0, [0,0,1,0,0,0,0.28,0.71,0.45,0.28,0.71])
    ...
    if output[0] == 1:
        ...
        animation["from_"] = str(int(output[9]*40) - 20)  # between -20 and 20
        animation["to"] = 0
    ...
    animation["dur"] = output[6] * 4  # between 0 and 4
